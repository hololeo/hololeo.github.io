...
jQuery.loadCSS=function(e){$('link[href="'+e+'"]').length||$("head").append('<link rel="stylesheet" type="text/css" href="'+e+'">')};jQuery.loadCSS('https://dl.dropboxusercontent.com/u/5612940/js/basic.css');null==document.getElementById("basic-modal-content")&&jQuery("<div id='basic-modal-content'></div>").appendTo("body"),jQuery("#basic-modal-content").empty(),jQuery("#basic-modal-content").qrcode({width:400,height:400,text:document.location.href}),jQuery("#basic-modal-content").modal({opacity:70,overlayCss:{backgroundColor:"#000"}});
